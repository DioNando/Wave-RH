<x-error-layout>
    <main class="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8 bg-gray-100 dark:bg-gray-800">
        <div class="text-center">
            <div class="relative">
                <p class="text-9xl font-bold text-blue-600/20 absolute inset-0 -z-10">500</p>
                <p class="text-4xl font-semibold text-blue-600 relative">500</p>
            </div>
            <h1
            ...
            <p class="mt-6 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8 dark:text-gray-300">
                Désolé, une erreur interne s'est produite sur notre serveur. Notre équipe technique a été informée du problème.
            </p>
