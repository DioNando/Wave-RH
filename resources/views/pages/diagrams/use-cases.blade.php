            ...
            <x-card>
                <x-card.card-body>
                    ...
                    <x-diagram.mermaid caption="Cas d'utilisation principaux de Wave HR">
                        ...
                        class
                        GestionCollaborateurs,GestionContrats,GestionConges,GestionOrganisation,GestionFinanciere,GestionFormations,GestionSysteme
                        ucGroup;
                        class
                        UC1,UC2,UC3,UC4,UC5,UC6,UC7,UC8,UC9,UC10,UC11,UC12,UC13,UC14,UC15,UC16,UC17,UC18,UC19,UC20,UC21,UC22,UC23,UC24,UC25,UC26,UC27,UC28,UC29
                        ucStyle;
                    </x-diagram.mermaid>
                </x-card.card-body>
            </x-card>
