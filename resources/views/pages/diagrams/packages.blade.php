<x-app-layout>
    <div>
        <h1 class="text-3xl font-bold mb-8">Diagramme de Packages - Architecture du système</h1>
...
flowchart TB
    ...
    class HistoriquePoste,HistoriqueConge,HistoriqueFormation,HistoriquePrime,HistoriqueAugmentation,ContactUrgence,InformationBancaire historyClass;
                </x-diagram.mermaid>
            </div>
