<x-form submit="store" class="px-4 sm:px-0">
    <div x-data="{ showForm: false }">
        <div x-show="showForm" class="grid grid-cols-1 border-b border-gray-900/10 dark:border-gray-700 pb-12">
            <h4 class="mb-4 text-lg font-medium text-green-700 dark:text-green-600">Nouvelle certification</h4>
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="col-span-full">
                    <x-form.group name="form.titre" label="Titre de la certification" required>
                        <x-form.input name="form.titre" required :live="true" />
                    </x-form.group>
                </div>
                <div class="col-span-full sm:col-span-3">
                    <x-form.group name="form.organisme" label="Organisme">
                        <x-form.input name="form.organisme" :live="true" />
                    </x-form.group>
                </div>
                <div class="col-span-full sm:col-span-3">
                ...
                <div class="col-span-full sm:col-span-3">
                    <x-form.group name="form.date_expiration" label="Date d'expiration">
                        <x-form.input type="date" name="form.date_expiration" :live="true" />
                    </x-form.group>
                </div>
                <div class="col-span-full">
