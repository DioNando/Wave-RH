    ...
    <div class="mt-5 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        @forelse ($documentsAdministratifs as $collaborateurId => $data)
            ...
            <div x-data="{ open: true }"
                class="bg-white dark:bg-gray-900 outline-1 outline-gray-200 dark:outline-gray-700 rounded-lg overflow-hidden">
                ...
                <div x-show="open" x-cloak class="p-4">
                    <div class="space-y-4">
                        @foreach ($documents as $row)
                            <div
                                class="flex items-start justify-between p-3 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
